<header class="main-header">
        ...
        <li class="dropdown notifications-menu">
                ...
                <ul class="dropdown-menu ">
                  ...
                  <li>
                      <div id="tournamentLeaderboard" class="slimScrollDiv hidden" style="position: relative; overflow: hidden; width: auto; ">
                          ...
                          <div class="box box-success box-solid">
                              <div class="box-header">
                                  <h3 class="box-title">Tournament <a class="fa fa-trophy"></a></h3>
                              </div><!-- /.box-header -->
                              <div class="box-body no-padding">
                                  <table id="tournamentTable" class="display table table-condensed">
                                      <thead>
                                      <tr>
                                          <th>Player</th>
